...
const UserForm = ({ users, selectedUser, setUsers }) => {
    ...
    const updateUser = async () => {
        ...
        const result = await updateDoc(userDoc, json).then(
                    ...
                    <Row>
                        ...
                        <Col md={6}>
                            <Form.Group className="mt-3" controlId="formBasicCheckbox">
                                <Form.Check type="checkbox" label="Add New" checked={newUser} onChange={() => checkBoxControl()} />
                            </Form.Group>
                        </Col>
                    </Row>
                    <Row className='mt-5'>
                        <Form.Group className='text-center'>
                            <Button className='w-50' variant='success' onClick={(newUser) ? addUser : updateUser}>{buttonText}</Button>
                        </Form.Group>
                    </Row>
                </Card.Body>
            </Card>
